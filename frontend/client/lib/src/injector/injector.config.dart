...
import '../features/session/cubit/session_cubit.dart' as _i17;
import '../features/wallets/cubit/wallets_cubit.dart' as _i19;
...
import '../repository/wallet/i_wallet_repository.dart' as _i15;
import '../repository/wallet/wallet_repository.dart' as _i16;
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i14.PropertyOwnersCubit>(() => _i14.PropertyOwnersCubit(
        gh<_i12.IPropertyOwnerRepository>(
            instanceName: 'PropertyOwnerRepository')));
    gh.singleton<_i15.IWalletRepository>(
      () => _i16.WalletRepository(gh<_i7.WalletsClient>()),
      instanceName: 'WalletRepository',
    );
    gh.singleton<_i17.SessionCubit>(() => _i17.SessionCubit(
        gh<_i10.IAuthenticationRepository>(
            instanceName: 'AuthenticationRepository')));
    gh.factory<_i18.LoginCubit>(() => _i18.LoginCubit(
        gh<_i10.IAuthenticationRepository>(
            instanceName: 'AuthenticationRepository')));
    gh.factory<_i19.WalletsCubit>(() => _i19.WalletsCubit(
        gh<_i15.IWalletRepository>(instanceName: 'WalletRepository')));
    return this;
  }
}
